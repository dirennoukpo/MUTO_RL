...
try:
    ...
    print("[yahboom_oled] Missing dependency: Adafruit_SSD1306")
    print("[yahboom_oled] Install with: sudo apt install -y python3-pip && python3 -m pip install Adafruit-SSD1306")
    sys.exit(1)
