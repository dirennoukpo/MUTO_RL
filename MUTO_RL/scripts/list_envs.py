...
All the environments are registered in the `MUTO_RL` extension. They start
...
import MUTO_RL.tasks  # noqa: F401


def main():
    """Print all environments registered in `MUTO_RL` extension."""
